...
**アプリの文言を変えたら、その画面のスクリーンショットも古くなる。**
v0.4.3 で About の「遅延は反映されません」を直したとき、掲載中の
05-about.png はその一文を映したままで、**ストアの画像が実装と矛盾していた**。
リリースノートと同じで、直したこと自体は忘れても、画像は残る。

文言・レイアウトを変えたら、影響する画面をここで撮り直す。駅一覧と方面の
選択（01/02）は v0.3 以降変わっていないので据え置き。
